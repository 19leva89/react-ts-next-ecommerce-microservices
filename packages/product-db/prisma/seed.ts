...
const mockProducts = [
	{
		...
		images: {
			gray: '/img/products/1g.png',
			purple: '/img/products/1p.png',
			green: '/img/products/1gr.png',
		},
	...
	},
	{
		...
		sizes: ['s', 'm', 'l', 'xl'],
		colors: ['gray', 'green'],
		images: { gray: '/img/products/2g.png', green: '/img/products/2gr.png' },
	...
	},
	{
		...
		images: {
			green: '/img/products/3gr.png',
			blue: '/img/products/3b.png',
			black: '/img/products/3bl.png',
		},
		categorySlug: 'jackets',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
	{
		...
		sizes: ['s', 'm', 'l'],
		colors: ['white', 'pink'],
		images: { white: '/img/products/4w.png', pink: '/img/products/4p.png' },
		categorySlug: 't-shirts',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
	{
		...
		images: {
			red: '/img/products/5r.png',
			orange: '/img/products/5o.png',
			black: '/img/products/5bl.png',
		},
		categorySlug: 'jackets',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
	{
		...
		sizes: ['40', '42', '43', '44'],
		colors: ['gray', 'white'],
		images: { gray: '/img/products/6g.png', white: '/img/products/6w.png' },
		categorySlug: 'shoes',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
	{
		...
		sizes: ['40', '42', '43'],
		colors: ['gray', 'pink'],
		images: { gray: '/img/products/7g.png', pink: '/img/products/7p.png' },
		categorySlug: 'shoes',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
	{
		...
		sizes: ['s', 'm', 'l'],
		colors: ['blue', 'green'],
		images: { blue: '/img/products/8b.png', green: '/img/products/8gr.png' },
		categorySlug: 't-shirts',
		createdAt: new Date(),
		updatedAt: new Date(),
	},
